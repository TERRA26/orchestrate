...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@orchestrate/shared/git`, `@orchestrate/shared/DrainableWorker`) — no barrel index.
