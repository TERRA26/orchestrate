...
// Purpose: Apply the app's typography scale (12 CSS variables) to the document root.
// Layer: Web appearance hook
// Exports: useAppTypography
...
export function useAppTypography(baseFontSizePx: number = DEFAULT_CHAT_FONT_SIZE_PX) {
  useEffect(() => {
