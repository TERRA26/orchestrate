...
export function resolveThreadRowClassName(input: {
  ...
  const baseClassName =
    "h-7 w-full translate-x-0 cursor-pointer justify-start rounded-md pr-2 pl-4 text-left text-[12px] select-none focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-ring";
