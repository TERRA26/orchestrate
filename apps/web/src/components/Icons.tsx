...
/**
 * Default an icon's `<svg>` to be decorative (aria-hidden=true,
 * focusable=false) unless the caller has supplied an accessible name
 * (aria-label / aria-labelledby) or set role="img". Caller props always
 * win, so an explicit `aria-hidden={false}` from the caller passes
 * through verbatim. [ORC-072]
 */
function decorativeIconProps(props: SVGProps<SVGSVGElement>): SVGProps<SVGSVGElement> {
...
export const GitHubIcon: Icon = (props) => (
  <svg {...decorativeIconProps(props)} viewBox="0 0 1024 1024" fill="none">
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
export const CursorIcon: Icon = (props) => (
  <svg {...decorativeIconProps(props)} viewBox="0 0 466.73 532.09" fill="currentColor">
...
export const VisualStudioCode: Icon = (props) => {
  ...
  return (
    <svg {...decorativeIconProps(props)} fill="none" viewBox="0 0 100 100">
...
export const Zed: Icon = (props) => {
  ...
  return (
    <svg {...decorativeIconProps(props)} fill="none" viewBox="0 0 96 96">
...
export const OpenAI: Icon = (props) => (
  <svg {...decorativeIconProps(props)} preserveAspectRatio="xMidYMid" viewBox="0 0 256 260" fill="currentColor">
...
export const ClaudeAI: Icon = (props) => (
  <svg {...decorativeIconProps(props)} preserveAspectRatio="xMidYMid" viewBox="0 0 256 257">
    <path
      fill="currentColor"
...
export const Gemini: Icon = (props) => (
  <svg {...decorativeIconProps(props)} viewBox="0 0 296 298" fill="none">
    <mask
      id="gemini__a"
      width="296"
      height="298"
...
export const AntigravityIcon: Icon = (props) => (
  <svg {...decorativeIconProps(props)} viewBox="0 0 128 128" fill="none">
    <image href={ANTIGRAVITY_ICON_DATA_URL} width="128" height="128" />
  </svg>
);

export const OpenCodeIcon: Icon = (props) => (
  <svg {...decorativeIconProps(props)} viewBox="0 0 32 40" fill="none" xmlns="http://www.w3.org/2000/svg">
