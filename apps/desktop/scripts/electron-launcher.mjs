// This file mostly exists because we want dev mode to say "Orchestrate (Dev)" instead of "electron"
...
const APP_BUNDLE_ID = isDevelopment ? "com.orchestrate.app.dev" : "com.orchestrate.app";
