...
export const ORCHESTRATE_TERMINAL_CLI_KIND_ENV_KEY = "ORCHESTRATE_TERMINAL_CLI_KIND";
export const ORCHESTRATE_TERMINAL_HOOK_OSC_PREFIX = "633;ORCHESTRATE_AGENT_EVENT=";
